...
type IntegrationsProps = {
  ...
  onPushToggle: (enable: boolean) => Promise<void>;
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          onClick={async () => {
            setPushLoading(true);
            try {
              await onPushToggle(!pushEnabled);
            } finally {
        ...
        >
          ...
          {pushEnabled ? "Push attive" : "Attiva push 15 min"}
        </button>
        ...
        >
          {wakeEnabled ? "Ehi Procione ON" : "Attiva Ehi Procione"}
        </button>
      </div>
    </section>
  );
